...
*📚 Total commands : 135*
*🪀 Criador* : @${configs.ownerList[0].split('@')[0]}
*🖊️ Prefix* : Multi
*⏰ Tempo* : ${moment().utcOffset('1000').format('YYYY-MM-DD HH:mm:ss')}
*💌 Rest API's* : https://supra-api.herokuapp.com
...
const ingfo = `Isto é para o preço do aluguel:
1semana :10 R$
1 mês: 20 R$
permanente: a negociar
SE TIVER INTERESSE #owner
`
...
const mess = {
			 ...
			 admin: 'ser usado apenas pelo administrador!',
			 botAdmin: 'Preciso ser adm do grupo',
			 limit: 'Seu limite de uso expirou, \n\ nObservação: o limite será redefinido a cada 00.00',
			 ownerOnly: 'Este comando é apenas para o dono!'
}
